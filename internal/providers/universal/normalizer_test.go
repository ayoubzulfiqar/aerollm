...
func TestHealthByIntentCoding(t *testing.T) {
	...
	if intent != "coding" {
		t.Fatalf("expected coding, got %s", intent)
	}
}
...
func TestHealthByIntentSummarization(t *testing.T) {
	...
	if intent != "summarization" {
		t.Fatalf("expected summarization, got %s", intent)
	}
}
...
func TestHealthByIntentTranslation(t *testing.T) {
	...
	if intent != "translation" {
		t.Fatalf("expected translation, got %s", intent)
	}
}
...
func TestHealthByIntentToolUse(t *testing.T) {
	...
	if intent != "tool_use" {
		t.Fatalf("expected tool_use, got %s", intent)
	}
}
